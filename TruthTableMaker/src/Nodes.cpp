...
// Требуется полное определение UserFunction для доступа к полю body.
// Надо подключить заголовочный файл, содержащий структуру UserFunction.
// #include "UserFunct.h" 
...
bool FunctNode::evaluate(Context ctx) const {
    ...
    // Примечание: Убедитесь, что в структуре UserFunction поле с поддеревом 
    // называется именно 'body' (или скорректируйте это имя ниже).
